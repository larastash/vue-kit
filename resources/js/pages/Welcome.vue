            ...
            <div class="absolute bottom-4 inset-x-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <figure class="shrink-0 size-1.5 rounded-full bg-green-500 dark:bg-green-600 ring-2 ring-green-300 dark:ring-green-400 animate-pulse"></figure>
...
import { ExternalLinkIcon, MoonIcon, SunIcon, SunMoonIcon } from 'lucide-vue-next';
...
onMounted(() => {
    setTimeout(() => {
        toast.success('Hey there 👋', {
            description: 'Now you can start to build something awesome.',
        });
    }, 1000);
});
</script>